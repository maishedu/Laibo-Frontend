          ...
          <div className="flex">
            ...
            <div>
              ...
              <p className="text-md font-semibold text-white">
                Stop distributing hard copies, they get scanned <br/> and uploaded on PDF sites
                Distribute e-books on <br/> Laibo instead. The "blank screenshot" feature <br/> prevents your work from being pirated and 
                ensures <br/> that you get every single shilling from your work.
              </p>
