          ...
          <div className="mb-12 lg:mb-0 w-full  ">
            <div className=" mb-6">
              ...
              <div class="relative">
                  ...
                  <span class="absolute inset-y-0 right-0 flex lg:hidden items-center pr-3">
            ...
            <Label>Location</Label>
              <div className="mb-3 rounded-lg bg-neutral-800 ">
               ...
               <div className="flex justify-center mb-3 space-x-3">
                <input placeholder="Min price" name="minPrice" value={searchDetails.minPrice} className="bg-neutral-800 w-32 rounded-lg text-white p-2" onChange={handleValueChange}/>
                <input placeholder="Max price" name="maxPrice" value={searchDetails.maxPrice} className="bg-neutral-800 w-32 rounded-lg text-white p-2" onChange={handleValueChange}/>
               </div>
