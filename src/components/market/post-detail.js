  ...
  return (
    ...
    <div className="px-4 py-16  mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <div className=" h-96 lg:h-full relative ">
       ...
       <Link href={`/user-profile/?id=${details?.customer_id}&username=${details?.seller_username}`}>
            <p className="mr-3">
              <img
      ...
      <div className="flex flex-col justify-center w-full">
        ...
        <div className="px-5 py-5 pb-5 mt-5 rounded ">
            <div className="mb-3 rounded-xl bg-neutral-800 px-3 py-3">
               ...
               <p className="text-white font-semibold ">Last: {details.selling_price.toFixed(2)}</p>
