        ...
        <div className="mx-auto  text-center items-center w-full lg:w-5/12 ">
          <div className={` px-5 pt-2 lg:mt-12 pb-5 text-start rounded sticky`}>
            ...
            <div className="mb-3 rounded-xl bg-neutral-800 ">
              <Select
                className="mt-1.5 w-full bg-neutral-800 px-3 py-3 text-white rounded-lg"
                name="type"
            ...
            <div>
              ...
              <p className="text-neutral-600 text-sm mb-3">
                The first photo will be used as your cover
              </p>
                ...
                {photos?.map((pic, index) => (
                  <div key={index} className=" relative mb-2">
                    <img
                      src={pic}
                      alt="book image"
                      className="relative object-fit w-20 h-20 rounded-lg"
                    />
                    <span
                      onClick={() => handleDelete(index)}
                      className="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-red-100 transform translate-x-1/2 -translate-y-1/2 bg-red-600 rounded-full cursor-pointer"
                    >
                      X
                    </span>
                  </div>
            ...
            <div className="mb-3 rounded-xl bg-neutral-800 ">
              <Select
                className="mt-1.5 bg-neutral-800 px-3 py-3 text-white rounded-lg"
                name="book_condition"
                value={updatedPost.book_condition}
                onChange={handleValueChange}
              >
